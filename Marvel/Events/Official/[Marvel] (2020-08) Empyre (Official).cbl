...
<!-- 
    Based on https://www.marvel.com/comics/discover/1968/empyre-the-complete-event
    Note: Several event issues are missing from this list (also missing from Marvel's website).
            Missing issue have been appended to the end of the list in a comment.
-->
<ReadingList xmlns:xsd="http://www.w3.org/2001/XMLSchema"
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <Name>[Marvel] (2020) Empyre (Official)</Name>
    <Books>
        ...
        <!-- 
            The following issues have been omitted from the official list:
